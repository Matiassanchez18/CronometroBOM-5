...
//    Agregar condicion logica
    ...
    intervalo = setInterval(() => {
        ...
        // Mostrar los minutos
        // Agregamos condicion logica (var < 10 ? 'o' : '') para que el resto de la division mientras sea menor a 10 se agregue un cero adelante de los segundos 
        cronometro.innerHTML = minutos + ':' + (segundosRestantes < 10 ? '0' : '') + segundosRestantes;}, 1000); 
}
